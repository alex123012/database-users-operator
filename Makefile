...
# databaseusersoperator.com/db-users-operator-bundle:$VERSION and databaseusersoperator.com/db-users-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= databaseusersoperator.com/db-users-operator
